...
<div class="wanted-poster">
    <h3>⚠ SYSTEM TRENDÓW AKTYWNY ⚠</h3>
    <p>Algorytm analizuje wyłącznie <b>ostatnie 100 losowań</b>, aby wyłapać najnowsze trendy (Hot Numbers).</p>
    <p>Zastosowano filtry: <b>Delta (Odstępy)</b> oraz <b>Prawo Powtórzeń</b>.</p>
...
def advanced_smart_generator(draws, game_name):
    ...
    # Jeśli baza jest większa, ucinamy ją.
    # Dzięki temu wagi będą bazować na "świeżych" trendach.
    ...
    # Pobieramy liczby z absolutnie ostatniego losowania (index 0)
...
st.markdown("---")
st.markdown("<div style='text-align: center; color: #888; font-size: 12px;'>Saloon Lotto 777 © 2024 | Trend 100 Edition</div>", unsafe_allow_html=True)
